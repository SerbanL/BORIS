...
namespace EqComp {
	...
	enum FUNC_ {
		...
		//Curie-Weiss law
		FUNC_CURIEWEISS, FUNC_CURIEWEISS_PMUL,
		FUNC_LONGRELSUS, FUNC_LONGRELSUS_PMUL,

		//Curie-Weiss law for 2-sublattice model
		FUNC_CURIEWEISS1, FUNC_CURIEWEISS1_PMUL, FUNC_CURIEWEISS2, FUNC_CURIEWEISS2_PMUL,
		FUNC_LONGRELSUS1, FUNC_LONGRELSUS1_PMUL, FUNC_LONGRELSUS2, FUNC_LONGRELSUS2_PMUL,
		FUNC_ALPHA1, FUNC_ALPHA1_PMUL, FUNC_ALPHA2, FUNC_ALPHA2_PMUL,
