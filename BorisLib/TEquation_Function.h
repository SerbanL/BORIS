...
namespace EqComp {
	...
	private:
		...
		double F_CurieWeiss(BVarType... bvars) const
		{
			if (pCurieWeiss) {
				...
				return pCurieWeiss->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 1.0;
		}

		double F_CurieWeiss_pmul(BVarType... bvars) const
		{
			if (pCurieWeiss) {
		...
		double F_CurieWeiss1(BVarType... bvars) const
		{
			if (pCurieWeiss1) {
				...
				return pCurieWeiss1->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 1.0;
		}

		double F_CurieWeiss1_pmul(BVarType... bvars) const
		{
			if (pCurieWeiss1) {
		...
		double F_CurieWeiss2(BVarType... bvars) const
		{
			if (pCurieWeiss2) {
				...
				return pCurieWeiss2->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 1.0;
		}

		double F_CurieWeiss2_pmul(BVarType... bvars) const
		{
			if (pCurieWeiss2) {
		...
		double F_LongRelSus(BVarType... bvars) const
		{
			if (pLongRelSus) {
				...
				return pLongRelSus->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 0.0;
		}

		double F_LongRelSus_pmul(BVarType... bvars) const
		{
			if (pLongRelSus) {
		...
		double F_LongRelSus1(BVarType... bvars) const
		{
			if (pLongRelSus1) {
				...
				return pLongRelSus1->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 0.0;
		}

		double F_LongRelSus1_pmul(BVarType... bvars) const
		{
			if (pLongRelSus1) {
		...
		double F_LongRelSus2(BVarType... bvars) const
		{
			if (pLongRelSus2) {
				...
				return pLongRelSus2->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 0.0;
		}

		double F_LongRelSus2_pmul(BVarType... bvars) const
		{
			if (pLongRelSus2) {
		...
		double F_Alpha1(BVarType... bvars) const
		{
			if (pAlpha1) {
				...
				return pAlpha1->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 1.0;
		}

		double F_Alpha1_pmul(BVarType... bvars) const
		{
			if (pAlpha1) {
		...
		double F_Alpha2(BVarType... bvars) const
		{
			if (pAlpha2) {
				...
				return pAlpha2->evaluate(pFunc1->func(*pFunc1, bvars...));
			}
			else return 1.0;
		}

		double F_Alpha2_pmul(BVarType... bvars) const
		{
			if (pAlpha2) {
	...
	public:
			...
			varvec(variables)
		{
			...
			case FUNC_CURIEWEISS_PMUL:
				func = &Function::F_CurieWeiss_pmul;
				break;
			...
			case FUNC_CURIEWEISS1_PMUL:
				func = &Function::F_CurieWeiss1_pmul;
				break;
			...
			case FUNC_CURIEWEISS2_PMUL:
				func = &Function::F_CurieWeiss2_pmul;
				break;
			...
			case FUNC_LONGRELSUS_PMUL:
				func = &Function::F_LongRelSus_pmul;
				break;
			...
			case FUNC_LONGRELSUS1_PMUL:
				func = &Function::F_LongRelSus1_pmul;
				break;
			...
			case FUNC_LONGRELSUS2_PMUL:
				func = &Function::F_LongRelSus2_pmul;
				break;
			...
			case FUNC_ALPHA1_PMUL:
				func = &Function::F_Alpha1_pmul;
				break;
			...
			case FUNC_ALPHA2_PMUL:
				func = &Function::F_Alpha2_pmul;
				break;
			}
		}
