...
class TransportCUDA_Spin_S_FuncsPolicy
{
private:
	...
	mcu_obj<TransportCUDA_Spin_S_Funcs, TransportCUDA_Spin_S_FuncsPolicy>& mng;
...
public:
	...
	TransportCUDA_Spin_S_FuncsPolicy(mcu_obj<TransportCUDA_Spin_S_Funcs, TransportCUDA_Spin_S_FuncsPolicy>& mng_, mGPUConfig& mGPU_) :
		mng(mng_),
		mGPU(mGPU_)
	{}
	...
	//assignment operator
	TransportCUDA_Spin_S_FuncsPolicy& operator=(const TransportCUDA_Spin_S_FuncsPolicy& copyThis) { return *this; }

	//destructor
	virtual ~TransportCUDA_Spin_S_FuncsPolicy() { clear_memory_aux(); }

	//////////////////////////////////////////////////////////////////////////////////
	//
	// TransportCUDA_Spin_S_FuncsPolicy Methods
