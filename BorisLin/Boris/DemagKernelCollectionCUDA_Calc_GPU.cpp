...
BError DemagKernelCollectionCUDA::Calculate_Demag_Kernels_2D_xShifted_onGPU(int index)
{
	BError error(__FUNCTION__);
...
BError DemagKernelCollectionCUDA::Calculate_Demag_Kernels_3D_xShifted_onGPU(int index)
{
	BError error(__FUNCTION__);
