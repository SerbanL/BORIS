...
public:
	...
	__host__ BError set_pointers(DifferentialEquationFMCUDA* pDiffEqCUDA, int idx_device);
...
public:
	...
	__host__ BError set_pointers(DifferentialEquationFMCUDA* pDiffEqCUDA, int idx_device) { return BError(); }
};
