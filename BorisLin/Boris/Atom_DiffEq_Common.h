...
//Differential equation for single lattice
typedef DBL3(Atom_DifferentialEquation::*Atom_Equation)(int idx);
//Differential equation for multiple sub-lattices
typedef DBL3(Atom_DifferentialEquation::*Atom_MEquation)(int sidx, int idx);
...
protected:
	...
	//function pointer to equation to solve (single lattice)
	static Atom_Equation equation;
	//function pointer to equation to solve (multiple sub-lattices)
	static Atom_MEquation mequation;
