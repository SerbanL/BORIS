...
Atom_MeshParams::Atom_MeshParams(std::vector<PARAM_>& enabledParams, int num_magnetic_sublattices)
{
	...
	for (int idx = 0; idx < (int)enabledParams.size(); idx++) {
		...
		case PARAM_GREL:
			...
			grel.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_DAMPING:
			meshParams.push_back("damping", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_ATOM_DAMPING);
			alpha.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_MUS:
			meshParams.push_back("mu_s", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "muB"), PARAM_ATOM_MUS);
			mu_s.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_J:
			meshParams.push_back("J", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J"), PARAM_ATOM_J);
			J.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_D:
			meshParams.push_back("D", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J"), PARAM_ATOM_D);
			D.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_DMI_DIR:
			meshParams.push_back("Ddir", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_DMI_DIR);
			D_dir.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_JS:
			meshParams.push_back("Js", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J"), PARAM_ATOM_JS);
			Js.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_JS2:
			meshParams.push_back("Js2", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J"), PARAM_ATOM_JS2);
			Js2.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_K1:
			meshParams.push_back("K1", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J"), PARAM_ATOM_K1);
			K1.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_K2:
			meshParams.push_back("K2", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J"), PARAM_ATOM_K2);
			K2.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_K3:
			meshParams.push_back("K3", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J"), PARAM_ATOM_K3);
			K3.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_EA1:
			meshParams.push_back("ea1", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_ATOM_EA1);
			mcanis_ea1.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_EA2:
			meshParams.push_back("ea2", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_ATOM_EA2);
			mcanis_ea2.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_ATOM_EA3:
			meshParams.push_back("ea3", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_ATOM_EA3);
			mcanis_ea3.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_DEMAGXY:
			meshParams.push_back("Nxy", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_DEMAGXY);
			Nxy.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_HA:
			meshParams.push_back("cHa", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_HA);
			cHA.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_HMO:
			meshParams.push_back("cHmo", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_HMO);
			cHmo.set_number_of_sublattices(num_magnetic_sublattices);
			break;

		case PARAM_S_EFF:
			meshParams.push_back("s_eff", MeshParamDescriptor(PARAMTYPE_MAGNETIC), PARAM_S_EFF);
			s_eff.set_number_of_sublattices(num_magnetic_sublattices);
			break;
