...
//Ferromagnetic
__device__ cuBReal ManagedMeshCUDA::Get_EnergyChange_FM_ZeemanCUDA(int spin_index, cuReal3 Mnew)
{
...
//Antiferromagnetic
__device__ cuReal2 ManagedMeshCUDA::Get_EnergyChange_AFM_ZeemanCUDA(int spin_index, cuReal3 Mnew_A, cuReal3 Mnew_B)
{
	cuVEC_VC<cuReal3>& M = *pM;
