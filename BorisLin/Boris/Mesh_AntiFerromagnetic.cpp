	...
	ProgramStateNames(this,
		{
			...
			VINFO(A_AFM), VINFO(Ah), VINFO(Anh), VINFO(D_AFM), VINFO(Dh), VINFO(dh_dir), VINFO(D_dir), VINFO(J1), VINFO(J2),
			VINFO(tau_ii), VINFO(tau_ij),
			...
			VINFO(density), VINFO(MEc), VINFO(mMEc), VINFO(MEc2), VINFO(mMEc2), VINFO(MEc3), VINFO(mMEc3), VINFO(Ym), VINFO(Pr), VINFO(cC), VINFO(cC2), VINFO(cC3), VINFO(cCs), VINFO(mdamping), VINFO(thalpha),
