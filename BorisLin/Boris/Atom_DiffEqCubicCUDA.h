...
private:
	...
	mcu_obj<ManagedAtom_DiffEqCubicCUDA, ManagedAtom_DiffEqPolicyCubicCUDA> cuaDiffEq;
...
public:
	...
	mcu_obj<ManagedAtom_DiffEqCubicCUDA, ManagedAtom_DiffEqPolicyCubicCUDA>& Get_ManagedAtom_DiffEqCUDA(void) { return cuaDiffEq; }
};
