...
//Demag computation on a single GPU for a portion of a mcuVEC, intended as part of a multi-GPU computation, and directed by SDemagCUDA.

class SDemagCUDA;

class SDemagMCUDA_single :
	public ConvolutionCUDA<SDemagMCUDA_single, DemagKernelCUDA>
{
	friend SDemagCUDA;
...
private:
	...
	SDemagCUDA* pSDemagMCUDA = nullptr;
...
public:
	...
	SDemagMCUDA_single(SDemagCUDA* pSDemagMCUDA_, int device_index_);
	~SDemagMCUDA_single();
