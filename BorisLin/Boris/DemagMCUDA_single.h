...
//Demag computation on a single GPU for a portion of a mcuVEC, intended as part of a multi-GPU computation, and directed by DemagMCUDA.

class MeshCUDA;
class DemagMCUDA;

class DemagMCUDA_single :
	public ConvolutionCUDA<DemagMCUDA_single, DemagKernelCUDA>
{
	friend DemagMCUDA;
...
private:
	...
	DemagMCUDA* pDemagMCUDA = nullptr;
...
public:
	...
	DemagMCUDA_single(MeshCUDA* pMeshCUDA_, DemagMCUDA* pDemagMCUDA_, int device_index_);
	~DemagMCUDA_single();
