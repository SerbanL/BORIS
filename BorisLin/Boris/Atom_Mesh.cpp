...
Atom_Mesh::Atom_Mesh(MESH_ meshType, SuperMesh *pSMesh_, int num_magnetic_sublattices) :
	...
	Atom_MeshParams(params_for_meshtype(meshType), num_magnetic_sublattices)
{
}
