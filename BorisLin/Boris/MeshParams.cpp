...
MeshParams::MeshParams(std::vector<PARAM_>& enabledParams)
{
	...
	for (int idx = 0; idx < (int)enabledParams.size(); idx++) {
		...
		case PARAM_MECOEFF2:
			meshParams.push_back("MEc2", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J/m3"), PARAM_MECOEFF2);
			break;

		case PARAM_MMECOEFF2:
			meshParams.push_back("mMEc2", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J/m3"), PARAM_MMECOEFF2);
			break;

		case PARAM_MECOEFF3:
			meshParams.push_back("MEc3", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J/m3"), PARAM_MECOEFF3);
			break;

		case PARAM_MMECOEFF3:
			meshParams.push_back("mMEc3", MeshParamDescriptor(PARAMTYPE_MAGNETIC, "J/m3"), PARAM_MMECOEFF3);
			break;
		...
		case PARAM_STIFFC_2:
			meshParams.push_back("cC2", MeshParamDescriptor(PARAMTYPE_MECHANICAL, "N/m2"), PARAM_STIFFC_2);
			break;

		case PARAM_STIFFC_3:
			meshParams.push_back("cC3", MeshParamDescriptor(PARAMTYPE_MECHANICAL, "N/m2"), PARAM_STIFFC_3);
			break;

		case PARAM_STIFFC_S:
			meshParams.push_back("cCs", MeshParamDescriptor(PARAMTYPE_MECHANICAL, "N/m2"), PARAM_STIFFC_S);
			break;
