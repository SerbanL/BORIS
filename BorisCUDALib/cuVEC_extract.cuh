...
__global__ void setup_profile_components_kernel(cuVEC<VType>& cuvec, cuBReal& step,
	cuReal2*& line_profile_component_x, cuReal2*& line_profile_component_y, cuReal2*& line_profile_component_z, size_t& line_profile_component_size, size_t*& line_profile_avpoints, cuBReal profile_offset)
{
	...
	if (idx < line_profile_component_size) {
		...
		line_profile_component_x[idx].i = (cuBReal)idx * step + profile_offset;
		line_profile_component_x[idx].j = 0.0;
	}
	else if (idx < 2 * line_profile_component_size) {

		line_profile_component_y[idx - line_profile_component_size].i = (cuBReal)(idx - line_profile_component_size) * step + profile_offset;
		line_profile_component_y[idx - line_profile_component_size].j = 0.0;
	}
	else if (idx < 3 * line_profile_component_size) {

		line_profile_component_z[idx - 2 * line_profile_component_size].i = (cuBReal)(idx - 2 * line_profile_component_size) * step + profile_offset;
...
template <typename VType>
__global__ void setup_profile_component_cuarr_kernel(cuVEC<VType>& cuvec, cuBReal& step, cuReal2* line_profile, size_t line_profile_size, size_t*& line_profile_avpoints, cuBReal profile_offset)
{
	...
	if (idx < line_profile_size) {
		...
		line_profile[idx].i = (cuBReal)idx * step + profile_offset;
...
__global__ void setup_profile_components_combined_kernel(cuVEC<VType>& cuvec, cuBReal& step,
	cuReal2*& line_profile_component_x, cuReal2*& line_profile_component_y, cuReal2*& line_profile_component_z, cuReal2* line_profile, size_t& line_profile_component_size, size_t*& line_profile_avpoints, cuBReal profile_offset)
{
	...
	if (idx < line_profile_component_size) {
		...
		line_profile[idx - 3 * line_profile_component_size].i = (cuBReal)(idx - 3 * line_profile_component_size) * step + profile_offset;
	...
	cuBReal profile_offset)
{
	...
	if (idx < line_profile_component_size) {
		...
		line_profile_component_x[idx].i = (cuBReal)idx * step + profile_offset;
		line_profile_component_y[idx].i = (cuBReal)idx * step + profile_offset;
		line_profile_component_z[idx].i = (cuBReal)idx * step + profile_offset;
...
template bool cuVEC<cuFLT3>::extract_profile_component_x(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);
template bool cuVEC<cuDBL3>::extract_profile_component_x(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);

template <typename VType>
__host__ bool cuVEC<VType>::extract_profile_component_x(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset)
{
	if (step > 0) {
		...
		if (num_stencil_points > size) {
			...
			setup_profile_component_cuarr_kernel <<< (size + CUDATHREADS) / CUDATHREADS, CUDATHREADS >>>
				(*this, step_gpu, profile_gpu, profile_gpu.size(), line_profile_avpoints, profile_offset);
			...
			setup_profile_components_kernel <<< (4 * size + CUDATHREADS) / CUDATHREADS, CUDATHREADS >>>
				(*this, step_gpu, line_profile_component_x, line_profile_component_y, line_profile_component_z, line_profile_component_size, line_profile_avpoints, profile_offset);

			//extract all 3 components
			extract_profile_component_max_kernel <<< (size + CUDATHREADS) / CUDATHREADS, CUDATHREADS >>>
				(*this, start, end, step, stencil, line_profile_component_size, aux_integer, profile_offset);
...
__host__ bool cuVEC<VType>::extract_profile_component_x(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, std::vector<DBL2>& profile_cpu)
{
	if (step > 0) {
		...
		if (num_stencil_points > size) {
			...
			//zero the profile storage
			setup_profile_components_kernel <<< (4 * size + CUDATHREADS) / CUDATHREADS, CUDATHREADS >>>
				(*this, step_gpu, line_profile_component_x, line_profile_component_y, line_profile_component_z, line_profile_component_size, line_profile_avpoints, 0);
			...
			extract_profile_component_max_kernel <<< (size + CUDATHREADS) / CUDATHREADS, CUDATHREADS >>>
				(*this, start, end, step, stencil, line_profile_component_size, aux_integer, 0);
		}
...
template bool cuVEC<cuFLT3>::extract_profile_component_y(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);
template bool cuVEC<cuDBL3>::extract_profile_component_y(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);

template <typename VType>
__host__ bool cuVEC<VType>::extract_profile_component_y(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset)
{
	if (step > 0) {
...
template bool cuVEC<cuFLT3>::extract_profile_component_z(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);
template bool cuVEC<cuDBL3>::extract_profile_component_z(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);

template <typename VType>
__host__ bool cuVEC<VType>::extract_profile_component_z(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset)
{
	if (step > 0) {
...
template int cuVEC<cuFLT3>::extract_profile_component_max(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);
template int cuVEC<cuDBL3>::extract_profile_component_max(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset);

template <typename VType>
__host__ int cuVEC<VType>::extract_profile_component_max(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, cu_arr<cuReal2>& profile_gpu, cuBReal profile_offset)
{
	if (step > 0) {
		...
		//make sure memory is allocated correctly
		if (!allocate_profile_component_memory(size)) return -1;

		//make sure profile_gpu has correct size
		if (!profile_gpu.resize(size)) return -1;
		...
		//component value to return : 0(x), 1(y), 2(z), detected below
		int component = -1;
		...
		if (num_stencil_points > size) {
			...
			setup_profile_components_combined_kernel <<< (5 * size + CUDATHREADS) / CUDATHREADS, CUDATHREADS >>>
				(*this, step_gpu, line_profile_component_x, line_profile_component_y, line_profile_component_z, profile_gpu, line_profile_component_size, line_profile_avpoints, profile_offset);
			...
			//value to return below
			component = get_gpu_value(aux_integer);
		}
...
template int cuVEC<cuFLT3>::extract_profile_component_max(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, std::vector<DBL2>& profile_cpu);
template int cuVEC<cuDBL3>::extract_profile_component_max(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, std::vector<DBL2>& profile_cpu);

template <typename VType>
__host__ int cuVEC<VType>::extract_profile_component_max(cuReal3 start, cuReal3 end, cuBReal step, cuReal3 stencil, std::vector<DBL2>& profile_cpu)
{
	if (step > 0) {
		...
		if (profile_cpu.size() != size) if (!malloc_vector(profile_cpu, size)) return -1;
