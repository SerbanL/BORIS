...
__global__ void set_ManagedFunctionCUDA_Unary(ManagedFunctionCUDA<BVarType...>& cuFunc, ManagedFunctionCUDA<BVarType...>& cuFunc1, int type)
{
	...
	if (idx == 0) {
		...
		case EqComp::FUNC_CURIEWEISS_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_CurieWeiss_pmul;
			break;
		...
		case EqComp::FUNC_CURIEWEISS1_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_CurieWeiss1_pmul;
			break;
		...
		case EqComp::FUNC_CURIEWEISS2_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_CurieWeiss2_pmul;
			break;
		...
		case EqComp::FUNC_LONGRELSUS_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_LongRelSus_pmul;
			break;
		...
		case EqComp::FUNC_LONGRELSUS1_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_LongRelSus1_pmul;
			break;
		...
		case EqComp::FUNC_LONGRELSUS2_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_LongRelSus2_pmul;
			break;
		...
		case EqComp::FUNC_ALPHA1_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_Alpha1_pmul;
			break;
		...
		case EqComp::FUNC_ALPHA2_PMUL:
			cuFunc.func = &ManagedFunctionCUDA<BVarType...>::F_Alpha2_pmul;
			break;
		}
	}
}
