...
__host__ void cuVEC_VC<VType>::set_cmbnd_continuous(size_t size, cuVEC_sec& V_sec, Class_CMBNDs& cmbndFuncs_sec, Class_CMBNDp& cmbndFuncs_pri, CMBNDInfoCUDA& contact)
{	
	if (size) {
...
template <typename VType, typename cuVEC_sec, typename Class_CMBNDs, typename Class_CMBNDp, typename Class_CMBND_S>
...
__host__ void cuVEC_VC<VType>::set_cmbnd_continuousflux(size_t size, cuVEC_sec& V_sec, Class_CMBNDs& cmbndFuncs_sec, Class_CMBNDp& cmbndFuncs_pri, Class_CMBND_S& cmbndFuncs_s, CMBNDInfoCUDA& contact)
{
	if (size) {
...
template <typename VType>
template <typename cuVEC_sec, typename Class_CMBNDs, typename Class_CMBNDp, typename Class_CMBND_S>
__host__ void cuVEC_VC<VType>::set_cmbnd_discontinuous(size_t size, cuVEC_sec& V_sec, Class_CMBNDs& cmbndFuncs_sec, Class_CMBNDp& cmbndFuncs_pri, Class_CMBND_S& cmbndFuncs_s, CMBNDInfoCUDA& contact)
{
	if (size) {
