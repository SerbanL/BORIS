...
struct CMBNDInfoCUDA {
	...
	__host__ void set_cells_box(const cuBox& cells_box_)
	{
	...
	//FOR TESTING
	__host__ cuBox get_cells_box(void) { return get_gpu_value(cells_box); }
	__host__ cuINT2 get_mesh_idx(void) { return get_gpu_value(mesh_idx); }
