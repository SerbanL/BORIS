...
bool Atom_Mesh_BCC::Get_Histogram(std::vector<double>& histogram_x, std::vector<double>& histogram_p, int num_bins, double& min, double& max, INT3 macrocell_dims)
{
#if COMPILECUDA == 1
	if (paMeshCUDA) {
...
bool Atom_Mesh_BCC::Get_ThAvHistogram(std::vector<double>& histogram_x, std::vector<double>& histogram_p, int num_bins, double& min, double& max, INT3 macrocell_dims)
{
#if COMPILECUDA == 1
	if (paMeshCUDA) {

		return reinterpret_cast<Atom_Mesh_BCCCUDA*>(paMeshCUDA)->Get_ThAvHistogram(histogram_x, histogram_p, num_bins, min, max, macrocell_dims);
	}
#endif
...
bool Atom_Mesh_BCC::Get_AngHistogram(std::vector<double>& histogram_x, std::vector<double>& histogram_p, int num_bins, double& min, double& max, INT3 macrocell_dims, DBL3 ndir)
{
#if COMPILECUDA == 1
	if (paMeshCUDA) {
...
bool Atom_Mesh_BCC::Get_ThAvAngHistogram(std::vector<double>& histogram_x, std::vector<double>& histogram_p, int num_bins, double& min, double& max, INT3 macrocell_dims, DBL3 ndir)
{
#if COMPILECUDA == 1
	if (paMeshCUDA) {

		return reinterpret_cast<Atom_Mesh_BCCCUDA*>(paMeshCUDA)->Get_ThAvAngHistogram(histogram_x, histogram_p, num_bins, min, max, macrocell_dims, ndir);
	}
#endif
...
DBL3 Atom_Mesh_BCC::GetThermodynamicAverageMagnetization(Rect rectangle)
{
	...
	if (paMeshCUDA) {
		...
		return reinterpret_cast<Atom_Mesh_BCCCUDA*>(paMeshCUDA)->GetThermodynamicAverageMagnetization(rectangle);
	}
#endif
