...
protected:
	...
	mcu_VEC(cuReal3) sEval0, sEval1, sEval2, sEval3, sEval4, sEval5, sEval6;

	//Thermal field and torques, enabled only for the stochastic equations
	mcu_VEC(cuReal3) H_Thermal, Torque_Thermal;
...
protected:
	...
	virtual void GenerateThermalField_CUDA(mcu_val<cuBReal>& deltaT) = 0;
	virtual void GenerateThermalField_and_Torque_CUDA(mcu_val<cuBReal>& deltaT) = 0;
