...
TransportBaseCUDA::TransportBaseCUDA(TransportBase* pTransportBase_) :
	...
	auxReal(mGPU),
	displayVEC(mGPU), displayVEC_VC(mGPU),
	dM_dt(mGPU), delsq_V_fixed(mGPU), delsq_S_fixed(mGPU),
	mesh_thermoelectric_net_current(mGPU),
	poisson_V(mGPU), poisson_Spin_V(mGPU), poisson_Spin_S(mGPU),
	charge_V_cmbnd_funcs_pri(mGPU), charge_V_cmbnd_funcs_sec(mGPU),
	spin_V_cmbnd_funcs_pri(mGPU), spin_V_cmbnd_funcs_sec(mGPU),
	spin_S_cmbnd_funcs_pri(mGPU), spin_S_cmbnd_funcs_sec(mGPU),
	TAMR_conductivity_equation(mGPU)
{
...
void TransportBaseCUDA::Set_STSolveType(void)
{
	...
	spin_V_cmbnd_funcs_pri.set_stsolve(stsolve);
	spin_V_cmbnd_funcs_sec.set_stsolve(stsolve);

	spin_S_cmbnd_funcs_pri.set_stsolve(stsolve);
	spin_S_cmbnd_funcs_sec.set_stsolve(stsolve);
}
