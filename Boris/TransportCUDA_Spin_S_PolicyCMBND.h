...
template <typename TransportCUDA_Spin_S_CMBND>
class TransportCUDA_Spin_S_PolicyCMBND
{
private:
	...
	mcu_obj<TransportCUDA_Spin_S_CMBND, TransportCUDA_Spin_S_PolicyCMBND>& mng;
...
public:
	...
	TransportCUDA_Spin_S_PolicyCMBND(mcu_obj<TransportCUDA_Spin_S_CMBND, TransportCUDA_Spin_S_PolicyCMBND>& mng_, mGPUConfig& mGPU_) :
		mng(mng_),
		mGPU(mGPU_)
	{}
	...
	//assignment operator
	TransportCUDA_Spin_S_PolicyCMBND& operator=(const TransportCUDA_Spin_S_PolicyCMBND& copyThis) { return *this; }

	//destructor
	virtual ~TransportCUDA_Spin_S_PolicyCMBND() { clear_memory_aux(); }

	//////////////////////////////////////////////////////////////////////////////////
	//
	// TransportCUDA_Spin_S_PolicyCMBND Methods
