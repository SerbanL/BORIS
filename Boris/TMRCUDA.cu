	...
	if (idx < n_e.x * n_e.y) {
		...
		if (elC.is_not_empty(idx)) {
			...
			for (int mesh_idx = 0; mesh_idx < pMeshFM_Top_size; mesh_idx++) {
				...
				mcuVEC_Managed<cuVEC_VC<cuReal3>, cuReal3>& M_Top = pMeshFM_Top[mesh_idx].pM->mcuvec();
			...
			if (m_top == cuReal3()) {
				...
				for (int mesh_idx = 0; mesh_idx < pMeshAtom_Top_size; mesh_idx++) {
					...
					mcuVEC_Managed<cuVEC_VC<cuReal3>, cuReal3>& M_Top = pMeshAtom_Top[mesh_idx].pM1->mcuvec();
					cuRect tmeshRect = M_Top.rect;
			...
			for (int mesh_idx = 0; mesh_idx < pMeshFM_Bot_size; mesh_idx++) {
				...
				mcuVEC_Managed<cuVEC_VC<cuReal3>, cuReal3>& M_Bot = pMeshFM_Bot[mesh_idx].pM->mcuvec();
			...
			if (m_bot == cuReal3()) {
				...
				for (int mesh_idx = 0; mesh_idx < pMeshAtom_Bot_size; mesh_idx++) {
					...
					mcuVEC_Managed<cuVEC_VC<cuReal3>, cuReal3>& M_Bot = pMeshAtom_Bot[mesh_idx].pM1->mcuvec();
					cuRect bmeshRect = M_Bot.rect;
