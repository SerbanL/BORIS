...
public:
	...
	__host__ BError set_pointers(Atom_DifferentialEquationCubicCUDA* paDiffEqCUDA, int device_idx);
...
public:
	...
	__host__ BError set_pointers(Atom_DifferentialEquationCubicCUDA* paDiffEqCUDA, int device_idx) { return BError(); }
};
