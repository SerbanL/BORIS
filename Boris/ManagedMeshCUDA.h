...
#else
	__device__ cuBReal Get_EnergyChange_FM(int spin_index, cuReal3 Mnew, int*& cuModules, int numModules, cuReal3& Ha) { return 0.0; }
	__device__ cuReal2 Get_EnergyChange_AFM(int spin_index, cuReal3 Mnew_A, cuReal3 Mnew_B, int*& cuModules, int numModules, cuReal3& Ha) { return cuReal2(); }
#endif
};
