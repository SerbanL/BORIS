...
#if COMPILECUDA == 1
	//return interfacial spin torque in given mesh with matching transport module
	mcu_VEC(cuReal3)& GetInterfacialSpinTorqueCUDA(TransportBase* pTransportBase);
#endif
...
public:
	...
	double GetOpenPotentialResistance(void) { return 0.0; }
	...
	//set open_potential_resistance value and associated settings
	BError SetOpenPotentialResistance(double open_potential_resistance_) { return BError(); }
