...
private:
	...
	static mcu_obj<ManagedDiffEq_CommonCUDA, ManagedDiffEqPolicy_CommonCUDA>* pcuDiffEq;
...
protected:
	...
	static mcu_val<cuBReal>* pdelta_M2_sq;
	static mcu_val<cuBReal>* pdelta_G2_sq;
	static mcu_val<cuBReal>* pdelta_M2_dot_delta_G2;
...
public:
	...
	mcu_obj<ManagedDiffEq_CommonCUDA, ManagedDiffEqPolicy_CommonCUDA>& Get_ManagedDiffEq_CommonCUDA(void) { return *pcuDiffEq; }
