...
public:
	...
	bool get_linked_el_dT(void) { return true; }
	...
	void Edit_Fixed_Surface(int idx, Rect rect) {}

	//get fixed surface index for surfgace with given minor Id (major Id is 0)
	int Get_Fixed_Surface_Index(int minorId) { return 0; }

	//get the minor id of fixed surface with given index
	int Get_Fixed_Surface_id(int index) { return -1; }
	...
	void Edit_Stress_Surface_Rectangle(int idx, Rect rect) {}
	void Edit_Stress_Surface_Equation(int idx, std::string equation) {}

	//get stress surface index for surfgace with given minor Id (major Id is 0)
	int Get_Stress_Surface_Index(int minorId) { return 0; }

	//get the minor id of stress surface with given index
	int Get_Stress_Surface_id(int index) { return -1; }
};
