	...
	ProgramStateNames(this,
		{
			...
			VINFO(thermCond), VINFO(density), VINFO(MEc), VINFO(mMEc), VINFO(MEc2), VINFO(mMEc2), VINFO(MEc3), VINFO(mMEc3), VINFO(Ym), VINFO(Pr), VINFO(cC), VINFO(cC2), VINFO(cC3), VINFO(cCs), VINFO(mdamping), VINFO(thalpha),
