...
#if COMPILECUDA == 1
	mcu_VEC(cuReal3)& GetStrayFieldCUDA(void) { return dynamic_cast<StrayFieldCUDA*>(pModuleCUDA)->GetStrayField(); }
#endif
};
...
#if COMPILECUDA == 1
	mcu_VEC(cuReal3) strayField_CUDA;
#endif
...
#if COMPILECUDA == 1
	mcu_VEC(cuReal3)& GetStrayFieldCUDA(void) { return strayField_CUDA; }
#endif
};
