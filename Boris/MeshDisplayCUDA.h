...
private:
	...
	//vectorial cuVEC_VC
	mcu_VEC_VC(cuReal3) display_vec_vc_vec_CUDA;

	//vectorial cuVEC
	mcu_VEC(cuReal3) display_vec_vec_CUDA;

	//scalar cuVEC_VC
	mcu_VEC_VC(cuBReal) display_vec_vc_sca_CUDA;

	//scalar cuVEC
	mcu_VEC(cuBReal) display_vec_sca_CUDA;
...
protected:
	...
	bool prepare_display(SZ3 n_quantity, Rect meshRect, double detail_level, mcu_VEC_VC(cuReal3)& cu_obj_quantity);
	bool prepare_display(SZ3 n_quantity, Rect meshRect, double detail_level, mcu_VEC_VC(cuReal3)& cu_obj_quantity, mcu_VEC_VC(cuReal3)& cu_obj_quantity2);
	
	bool prepare_display(SZ3 n_quantity, Rect meshRect, double detail_level, mcu_VEC_VC(cuBReal)& cu_obj_quantity);
	
	bool prepare_display(SZ3 n_quantity, Rect meshRect, double detail_level, mcu_VEC(cuReal3)& cu_obj_quantity);
	bool prepare_display(SZ3 n_quantity, Rect meshRect, double detail_level, mcu_VEC(cuReal3)& cu_obj_quantity, mcu_VEC(cuReal3)& cu_obj_quantity2);
	
	bool prepare_display(SZ3 n_quantity, Rect meshRect, double detail_level, mcu_VEC(cuBReal)& cu_obj_quantity);
};
