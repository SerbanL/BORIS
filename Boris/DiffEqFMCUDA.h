...
private:
	...
	mcu_obj<ManagedDiffEqFMCUDA, ManagedDiffEqPolicyFMCUDA> cuDiffEq;
...
public:
	...
	mcu_obj<ManagedDiffEqFMCUDA, ManagedDiffEqPolicyFMCUDA>& Get_ManagedDiffEqCUDA(void) { return cuDiffEq; }
};
