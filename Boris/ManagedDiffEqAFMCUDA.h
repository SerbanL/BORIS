...
public:
	...
	__host__ BError set_pointers(DifferentialEquationAFMCUDA* pDiffEqCUDA, int device_idx);
...
public:
	...
	__host__ BError set_pointers(DifferentialEquationAFMCUDA* pDiffEqCUDA, int device_idx) { return BError(); }
};
